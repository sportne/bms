...
public final class ConditionalRelationalFrame {
  ...
  public byte[] encode() {
    ...
    if ((((this.version & 0xFFL) >= 2L) && ((this.version & 0xFFL) <= 10L))) {
    writeUInt8(out, this.betweenMode);
    }
    if (((((this.version & 0xFFL) == 2L) || ((this.version & 0xFFL) == 3L)) && ((this.version & 0xFFL) < 5L))) {
    writeUInt8(out, this.compoundMode);
    }
  ...
  public static ConditionalRelationalFrame decode(ByteBuffer input) {
    ...
    if ((((value.version & 0xFFL) >= 2L) && ((value.version & 0xFFL) <= 10L))) {
    value.betweenMode = readUInt8(input);
    }
    if (((((value.version & 0xFFL) == 2L) || ((value.version & 0xFFL) == 3L)) && ((value.version & 0xFFL) < 5L))) {
    value.compoundMode = readUInt8(input);
    }
    return value;
  }
