...
/**
 * Provides detailed C++ backend support checks for resolved members and type references.
 *
 * <p>{@link CppSupportChecker} owns orchestration. This class owns per-member and per-type-ref
 * validation logic.
 */
final class CppMemberSupportChecker {
  /** Prevents instantiation of this static utility class. */
  private CppMemberSupportChecker() {}
