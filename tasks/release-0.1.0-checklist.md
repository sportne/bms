...
- [ ] README support status matches the shipped behavior exactly.
- [ ] Roadmap and backlog status are updated to reflect what was completed.
- [ ] Any known limitations are documented clearly in plain language.

## Versioning + release notes

- [ ] Version is set to `0.1.0`.
- [ ] Changelog/release notes summarize features, fixes, and known limits.
- [ ] Git tag `v0.1.0` points to the exact release commit.

## Post-release follow-up

- [ ] Open follow-up items for `1.0.0` hardening work.
